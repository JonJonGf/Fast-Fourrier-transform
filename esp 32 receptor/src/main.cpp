 ...
 * Velocidade: 9600 baud (Bits mais largos = sem erro de transição)
...
void setup() {
  // Configura a USB com o PC 2 para 9600 baud
  Serial.begin(9600);
  ...
  // Inicializa a linha óptica em 9600 baud em modo NORMAL
  Serial2.begin(9600, SERIAL_8N1, RECEPTOR_PIN, TX_DUMMY_PIN);
  Serial2.setRxBufferSize(1024);

  Serial.println("==================================================");
  Serial.println("  [RECEPTOR 9600] PRONTO COM PULL-UP INTERNO ATIVO");
  Serial.println("==================================================");
